<div>
    <div class="card">
        <div class="card-header">
            ...
            <div class="d-flex">
                <a href="{{ route('admin.sucursales.create') }}" class="btn btn-block btn-danger w-25 m-2"><i class="fa-solid fa-map-location-dot mr-1"></i>Nueva Sucursal</a>
            ...
            <table id="" class="table table-bordered table-striped">
                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td>{{$sucursal->distrito->distrito}}</td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="{{ route('admin.sucursales.edit', ['sucursale' => $sucursal->id ]) }}" class="dropdown-item"><i class="fas fa-pen-to-square mr-1"></i>Editar Sucursal</a>
                                    <a href="#" class="dropdown-item"><i class="fas fa-trash mr-1"></i>Eliminar Sucursal</a>
                                </div>
                            </div>
                        </td>
                    </tr>
